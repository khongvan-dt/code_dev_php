              ...
              <form method="post" enctype="multipart/form-data">
                    <div class="row gx-2">
                        <div class="col-12 mb-3">
                            ...
                            <input class="form-control" id="product-name" type="text" name="product_name" placeholder="Nhập tên sản phẩm..."/>
                            <?php if (isset($errors['loi1'])) { echo $errors['loi1']; } ?>
                        </div>
                        <div class="col-12 mb-3">
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <?php if (isset($errors['loi2'])) { echo $errors['loi2']; } ?>
                        </div>
                        <div class="col-12 mb-3">
                            <label class="form-label" for="product-price">Giá sản phẩm:</label>
                            <input type="number" class="form-control" id="product-price" name="product_price" placeholder="Nhập giá sản phẩm..."/>
                            <?php if (isset($errors['loi2'])) { echo $errors['loi2']; } ?>
                        </div>
                        <div class="col-12 mb-3">
                            <label class="form-label" for="price-discount">Giá giảm giá:</label>
                            <input type="number" class="form-control" id="price-discount" name="price_discount" placeholder="Nhập giá giảm giá..."/>
                            <?php if (isset($errors['loi5'])) { echo $errors['loi5']; } ?>
                        </div>
                        <div class="col-12 mb-3">
                            <label class="form-label" for="product-summary">Nội dung sản phẩm:</label>
                            <textarea class="form-control" id="product-summary" name="content" placeholder="Nhập nội dung sản phẩm..."></textarea>
                            <?php if (isset($errors['loi6'])) { echo $errors['loi6']; } ?>
                        </div>
                      
                        <div class="col-12 mb-3">
                            <label class="form-label" for="product-description">Mô tả sản phẩm:</label>
                            <textarea class="form-control" id="product-description" name="description" rows="6" placeholder="Nhập mô tả sản phẩm..."></textarea>
                            <?php if (isset($errors['loi6'])) { echo $errors['loi6']; } ?>
                        </div>
                        <div class="col-12 mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="is_host" name="is_host" value="1">
